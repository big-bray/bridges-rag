"""Run a Retriever over the benchmark and aggregate Recall@k and MRR."""
...
def _ranked_paper_ids(retriever: Retriever, question: BenchmarkQuestion) -> list[str]:
...
def evaluate(retriever: Retriever, questions: Sequence[BenchmarkQuestion]) -> EvalResults:
    ...
    for question in questions:
        ranked = _ranked_paper_ids(retriever, question)
